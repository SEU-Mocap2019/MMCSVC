...
class SMPLModel():
  ...
  def update(self):
    ...
    self.joints = self.J_regressor.dot(self.verts)
    #print(self.joints)
...
if __name__ == '__main__':
  ...
  smpl.save_to_obj('./smpl_np5.obj')
  #(_, A_global) =global_rigid_transformation(pose, smpl.J, smpl.kintree_table,xp=np)
  ...
  smpl.set_params(beta=beta, pose=pose, trans=trans)
  print("pose:",smpl.pose)
  (_, A_global) = global_rigid_transformation(pose, fuck, smpl.kintree_table,xp=np)
  print(A_global)
...
"""
  ...
  print(pose)
  beta =(np.random.rand(*smpl.beta_shape) - 0.5) *0.1
  print(beta)
"""


  #trans=deepcopy(smpl.J[0]*9)
  #smpl.J=smpl.J*9-trans
  #smpl.v_template=smpl.v_template*9-trans 
  #influence position dont know senior's meaning 

  #smpl.save_to_obj('./smpl_np3.obj')
